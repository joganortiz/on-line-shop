...
export class Init1698982779926 implements MigrationInterface {
    name = 'Init1698982779926'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`
            CREATE TABLE \`states\` (
                ...
                \`fips_code\` varchar(255) CHARACTER SET "utf8mb4" COLLATE "utf8mb4_general_ci" NOT NULL,
        ...
        await queryRunner.query(`
            CREATE TABLE \`countries\` (
                ...
                \`phonecode\` varchar(255) CHARACTER SET "utf8mb4" COLLATE "utf8mb4_general_ci" NOT NULL,
                \`capital\` varchar(255) CHARACTER SET "utf8mb4" COLLATE "utf8mb4_general_ci" NOT NULL,
                ...
                \`tld\` varchar(255) CHARACTER SET "utf8mb4" COLLATE "utf8mb4_general_ci" NOT NULL,
