...
import { getCountryRepository } from '../../dependencies';
import { CountryGetterByIdUseCase } from '../../../application';

export class GetByIdCountriesController {
    ...
    run = async (req: Request, res: Response): Promise<void> => {
        try {
            const caseOfUseGetAllCountries = new CountryGetterByIdUseCase(
